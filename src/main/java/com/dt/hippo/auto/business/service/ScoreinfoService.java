...
/**
 * Business Service Interface for entity Scoreinfo.
 */
public interface ScoreinfoService { 
	 ...
	 * @return entity
	 */
	Scoreinfo save(Scoreinfo entity);
	 ...
	 * @return
	 */
	Scoreinfo update(Scoreinfo entity);
	 ...
	 * @return
	 */
	Scoreinfo create(Scoreinfo entity);
