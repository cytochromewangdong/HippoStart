...
public class ComboinfoServiceImpl implements ComboinfoService {
	...
	@Override
	public Comboinfo findById(Long uid) {
		ComboinfoEntity comboinfoEntity = comboinfoJpaRepository.findOne(uid);
...
//		ComboinfoEntity comboinfoEntity = comboinfoJpaRepository.findOne(comboinfo.getUid());
...
//		}
	...
	public void delete(Long uid) {
		comboinfoJpaRepository.delete(uid);
	}
