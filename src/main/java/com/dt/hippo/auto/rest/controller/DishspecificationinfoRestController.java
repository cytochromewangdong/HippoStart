...
public class DishspecificationinfoRestController {
	...
	@RequestMapping( value="/dishspecificationinfo/{uid}",
			method = RequestMethod.GET,
			produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseStatus(HttpStatus.OK)
	@ResponseBody
	public Dishspecificationinfo findOne(@PathVariable("uid") Long uid) {
		return dishspecificationinfoService.findById(uid);
	}
    ...
    @ResponseStatus(HttpStatus.OK)
	@ResponseBody
	public Dishspecificationinfo update(@PathVariable("uid") Long uid, @RequestBody Dishspecificationinfo dishspecificationinfo) {
	...
	public void delete(@PathVariable("uid") Long uid) {
		dishspecificationinfoService.delete(uid);
	}
