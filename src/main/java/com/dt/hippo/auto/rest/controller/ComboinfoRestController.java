...
public class ComboinfoRestController {
	...
	@RequestMapping( value="/comboinfo/{id}",
			method = RequestMethod.GET,
			produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseStatus(HttpStatus.OK)
	@ResponseBody
	public Comboinfo findOne(@PathVariable("id") Long id) {
		return comboinfoService.findById(id);
	}
    ...
    @ResponseStatus(HttpStatus.OK)
	@ResponseBody
	public Comboinfo update(@PathVariable("id") Long id, @RequestBody Comboinfo comboinfo) {
