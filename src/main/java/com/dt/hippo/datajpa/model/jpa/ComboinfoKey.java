...
/**
 * Composite primary key for entity "Comboinfo" ( stored in table "comboinfo" )
 *
 * @author Telosys Tools Generator
 *
 */
 @Embeddable
public class ComboinfoKey implements Serializable {
    ...
    public ComboinfoKey( Long uid, Long childid, Long specificationid ) {
        super();
        this.uid = uid ;
	...
	public boolean equals(Object obj) { 
		...
		ComboinfoKey other = (ComboinfoKey) obj; 
		//--- Attribute uid
		if ( uid == null ) { 
			if ( other.uid != null ) 
				return false ; 
